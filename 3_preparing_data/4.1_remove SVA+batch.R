...
variables <- cbind(svd_custom$sv, age)

data_adj_all <- removeBatchEffect(data, batch=sex, batch2=transplant, covariates=variables, design=mod1)


setwd("/mnt/iusers01/bk01/m20349jk/causal_hypertension/eQTL/pval_01/data/")
save(svd_custom, file = "svd_all.Rdata")
save(data_adj_all, file = "data_adj_all.Rdata")